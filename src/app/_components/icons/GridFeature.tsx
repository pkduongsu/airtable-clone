interface GridFeatureIconProps {
    className?: string,
    size?: number,
    color?: string,
}

export default function GridFeature({className, size, color}:GridFeatureIconProps) {
    return (
        <svg 
            width={size} 
            height={size} 
